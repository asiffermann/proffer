namespace Proffer.Templating.Handlebars.Tests
{
    ...
    public class HandlebarsFixture : ServiceProviderFixtureBase
    {
        ...
        public class TemplateCollection : TemplateCollectionBase
        {
            ...
            public Task<string> Contacts(ContactsContext context, IFormatProvider formatProvider = null)
                => this.LoadAndApplyTemplate("Contacts", context, formatProvider);

            public Task<string> BadContext(object context, IFormatProvider formatProvider = null)
                => this.LoadAndApplyTemplate("BadContext", context, formatProvider);
